            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        ...
                        <div class="heading-text text-white about-text" style="color: white !important;">
                            {!! $setting->about !!}
                        </div>
                    </div>
                </div>
            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{$setting->contact_phone}}</a>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{$setting->site_address}}</a>
                            <p class="sub-title">Go Vap District, Nguyen Oanh street</p>
                        </div>
                    </div>
                </div>
            </div>
